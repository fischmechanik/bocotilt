...
PATH_TF_DATA     = '/mnt/data_dump/bocotilt/4_ersp_tilt_only/';
PATH_FIELDTRIP   = '/home/plkn/fieldtrip-master/';
PATH_OUT         = '/mnt/data_dump/bocotilt/4_ersp_tilt_only/out/';
...
if ismember('part1', to_execute)
    ...
    for s = 1 : length(subject_list)
        ...
        % Get condition idx
        idx_std_rep = EEG.trialinfo(:, 4) == 0 & EEG.trialinfo(:, 10) == 0 & EEG.trialinfo(:, 5) == 1;
        idx_std_swi = EEG.trialinfo(:, 4) == 0 & EEG.trialinfo(:, 10) == 1 & EEG.trialinfo(:, 5) == 1;
        idx_bon_rep = EEG.trialinfo(:, 4) == 1 & EEG.trialinfo(:, 10) == 0 & EEG.trialinfo(:, 5) == 1;
        idx_bon_swi = EEG.trialinfo(:, 4) == 1 & EEG.trialinfo(:, 10) == 1 & EEG.trialinfo(:, 5) == 1;
